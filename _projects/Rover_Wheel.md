...
This wheel was printed using TPU on a Bambu Lab P2S printer. This design was 10.5 in tall and 9 in wide. It only printed halfway because it was too wide and would have used too much TPU printing if continued. This is why I reduced the width to 4 in but still made it be wider than last year's design. Its treads were modeled after the Perseverance Rover but were changed because I received feedback that the soil that the rover would be traversing across would be different from the actual Martian soil. This wheel also lacked curvature along its width, so I added a slight curve to the new design to allow easier and smoother turns without excessive loading on the edges. I also increased the curvature of the lightening holes. Increased curvature allows the wheel to deform elastically under the rover weight in a controlled manner. It also improves durability and reduces unpredictable material behavior.
